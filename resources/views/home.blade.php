      ...
      <div class="card text-bg-info shadow-sm">
        <div class="card-body">
          <div class="d-flex flex-row align-items-center justify-content-between mb-3">
            ...
            <div class="fw-semibold fs-3 text-light mt-3"><u>{{ $users }}</u></div>
      ...
      <div class="card text-bg-secondary shadow-sm">
        <div class="card-body">
          <div class="d-flex flex-row align-items-center justify-content-between mb-3">
            ...
            <div class="fw-semibold fs-3 text-light mt-3"><u>{{ $akuns }}</u></div>
      ...
      <div class="card text-bg-warning shadow-sm">
        <div class="card-body">
          <div class="d-flex flex-row align-items-center justify-content-between mb-3">
            ...
            <div class="fw-semibold fs-3 text-light mt-3"><u>{{ $barangs }}</u></div>
      ...
      <div class="card text-bg-success shadow-sm">
        <div class="card-body">
          <div class="d-flex flex-row align-items-center justify-content-between mb-3">
            ...
            <div class="fw-semibold fs-3 text-light mt-3"><u>{{ $pinjams }}</u></div>
